...
export default function EndScreen({ 
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black overflow-hidden p-4 w-full"
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-2xl text-center">
        ...
        {isVictory ? (
          <>
            ...
            >
              <Award className="w-24 h-24 text-neon-blue drop-shadow-[0_0_30px_rgba(0,243,255,0.8)] mb-4 mx-auto" />
            </motion.div>
            <h2 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-neon-green to-neon-blue text-glow-blue mb-2 uppercase tracking-tight">
              Viaggio<br/>Completato!
            </h2>
            <p className="text-xl md:text-2xl text-green-200 mb-8 font-light tracking-widest uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Sei una Leggenda
            </p>
          </>
        ) : (
          <>
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 200, damping: 20 }}
            >
              <Skull className="w-24 h-24 text-red-500 drop-shadow-[0_0_30px_rgba(239,68,68,0.8)] mb-4 mx-auto" />
            </motion.div>
            <h2 className="text-5xl md:text-7xl font-black text-red-500 text-glow-purple mb-2 uppercase tracking-tight">
              Busted!
            </h2>
        ...
        <motion.div 
          ...
          className="bg-black/60 border border-gray-800 rounded-2xl p-6 w-full mb-8 backdrop-blur-sm shadow-2xl"
        >
          <h3 className="text-xl md:text-2xl font-bold text-white mb-6 uppercase tracking-wider border-b border-gray-700 pb-2">
            Resoconto Viaggio
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="flex flex-col items-center justify-center p-3 bg-white/5 rounded-xl border border-white/10">
              ...
              <span className="text-sm font-bold text-white text-center leading-tight">{character?.name || '-'}</span>
            </div>
            
            <div className="flex flex-col items-center justify-center p-3 bg-white/5 rounded-xl border border-white/10">
              <Package className="w-8 h-8 text-green-400 mb-2 drop-shadow-[0_0_8px_rgba(74,222,128,0.5)]" />
              <span className="text-[10px] text-gray-400 uppercase tracking-widest">Stash</span>
              <span className="text-lg font-bold text-green-400">{stash}g</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center p-3 bg-white/5 rounded-xl border border-white/10">
              <Heart className="w-8 h-8 text-red-400 mb-2 drop-shadow-[0_0_8px_rgba(248,113,113,0.5)]" />
          ...
          <div className="bg-purple-900/40 border border-purple-500/50 p-4 rounded-xl flex items-center justify-center gap-4 shadow-[0_0_15px_rgba(168,85,247,0.3)]">
            <span className="text-4xl animate-pulse drop-shadow-[0_0_10px_rgba(168,85,247,0.8)]">☯</span>
            <div className="text-left">
              <p className="text-sm text-purple-300 uppercase tracking-widest">Karma Ottenuto</p>
              <p className="text-3xl font-black text-neon-purple drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]">+{earnedKarma}</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.button 
          ...
          className={`group relative overflow-hidden text-black font-black text-xl py-4 px-12 rounded-full uppercase tracking-widest transition-all border-2 border-black
            ${isVictory 
